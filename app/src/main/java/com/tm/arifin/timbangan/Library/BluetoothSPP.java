...
package com.tm.arifin.timbangan.Library;
...
public class BluetoothSPP {
    ...
    public void connect(Intent data) {
        ...
        Log.e("alamat 2",address);
    }
    
    public void connect(String address) {
        Log.e("alamat",address);//98:D3:31:30:73:4D
        BluetoothDevice device = mBluetoothAdapter.getRemoteDevice("98:D3:31:30:73:4D");
        //setupService();
        if(mChatService !=null)
        {

            Log.e("connek ka ","asddddd");//98:D3:31:30:73:4D
            mChatService.connect(device);
        }
        else
        {
            Log.e("connek ka ","Mservice Null");//98:D3:31:30:73:4D
        }
//        mChatService.connect(device);
...
//            btSocket = dispositivo.createInsecureRfcommSocketToServiceRecord(UUID.fromString("00001101-0000-1000-8000-00805F9B34FB"));//create a RFCOMM (SPP) connection
...
//        if(btSocket !=null)
//        {
//            String alamat = btSocket.getRemoteDevice().getAddress();
//            Log.e("connek ka ",alamat);//98:D3:31:30:73:4D
//        }
    }
